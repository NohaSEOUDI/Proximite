 ...
 */
final class Version20210415211852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, fournisseur_id INT DEFAULT NULL, client_id INT DEFAULT NULL, validee_par_fournisseur TINYINT(1) DEFAULT NULL, jour DATE DEFAULT NULL, heure VARCHAR(255) DEFAULT NULL, duree INT DEFAULT NULL, frais INT DEFAULT NULL, INDEX IDX_42C84955ED5CA9E6 (service_id), INDEX IDX_42C84955670C757F (fournisseur_id), INDEX IDX_42C8495519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
