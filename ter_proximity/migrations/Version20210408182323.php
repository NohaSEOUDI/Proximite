 ...
 */
final class Version20210408182323 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Reservations (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, client_id INT NOT NULL, fournisseur_id INT NOT NULL, validee_par_fournisseur TINYINT(1) DEFAULT NULL, jour DATE DEFAULT NULL, heure TIME DEFAULT NULL, duree TIME DEFAULT NULL, frais INT DEFAULT NULL, INDEX IDX_187C79C1ED5CA9E6 (service_id), INDEX IDX_187C79C119EB6921 (client_id), INDEX IDX_187C79C1670C757F (fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fournisseur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(25) NOT NULL, nom VARCHAR(25) NOT NULL, prenom VARCHAR(25) NOT NULL, politique VARCHAR(255) NOT NULL, frais INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE Reservations ADD CONSTRAINT FK_187C79C1ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Reservations ADD CONSTRAINT FK_187C79C119EB6921 FOREIGN KEY (client_id) REFERENCES users (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Reservations ADD CONSTRAINT FK_187C79C1670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Reservations DROP FOREIGN KEY FK_187C79C1670C757F');
        $this->addSql('ALTER TABLE service DROP FOREIGN KEY FK_E19D9AD2670C757F');
        $this->addSql('ALTER TABLE Reservations DROP FOREIGN KEY FK_187C79C1ED5CA9E6');
        ...
        $this->addSql('ALTER TABLE Reservations DROP FOREIGN KEY FK_187C79C119EB6921');
