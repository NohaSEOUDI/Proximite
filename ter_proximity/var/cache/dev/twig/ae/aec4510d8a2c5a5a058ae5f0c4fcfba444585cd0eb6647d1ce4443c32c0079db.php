...
class __TwigTemplate_6f642c6b147185407debde4556729e4a36cc17633eca6886ed699e9896215a29 extends Template
{
    private $source;
    private $macros = [];
...
<button type=\"button\" class=\"btn btn-warning\"><a href=\"{{ url('app_reset_password', {token: resetToken.token}) }}\">{{ url('app_reset_password', {token: resetToken.token}) }}</a></button>
...
Montpellier
</div>", "reset_password/email.html.twig", "/home/noisette/L3_20-21/S6/ter-l3-proximite/ter_proximity/templates/reset_password/email.html.twig");
    }
}
